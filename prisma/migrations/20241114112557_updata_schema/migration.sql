/*
  ...
  - The primary key for the `UserReward` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
-- AlterTable
ALTER TABLE "UserReward" DROP CONSTRAINT "UserReward_pkey",
ALTER COLUMN "userId" SET DATA TYPE TEXT,
ADD CONSTRAINT "UserReward_pkey" PRIMARY KEY ("userId", "rewardId");
